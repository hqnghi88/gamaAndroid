...
public class Cast {
	...
	// @doc(value =
	// "casting of the operand to an agent (if a species name is used, casting
	// to an instance of species name).",
	// special_cases = {
	// "if the operand is a point, returns the closest agent (resp. closest
	// instance of species name) to that point (computed in the topology of the
	// calling agent);",
	// "if the operand is an agent, returns the agent (resp. tries to cast this
	// agent to species name and returns nil if the agent is instance of another
	// species);",
	// "if the operand is an int, returns the agent (resp. instance of species
	// name) with this unique index;" },
	// examples = {
	// "species node {}", "node(0) --: node0", "node(3.78) --: null",
	// "node(true) --: null",
	// "node({23, 4.0} --: node2", "node(5::34) --: null", "node(green) --:
	// null", "node([1,5,9,3]) --: null",
	// "node(node1) --: node1", "node('4') --: null" }, see = { "of_species",
	// "species" })
	...
	// @doc(value = "casting of the left-hand operand to a species.",
	// special_cases = {
	// "if the right-hand operand is nil, transforms the left-hand operand into
	// an agent",
	// "if the left-hand operand is nil, returns nil",
	// "if the left-operand is a integer, returns an agent of the species with
	// the right-operans as id",
	// "if the left-operand is a point, returns the agent of the species closest
	// to the right-hand operand",
	// "otherwise, returns nil" }, see = { "agent" })
	// public static IAgent asAgent(final IScope scope, final Object val, final
	// ISpecies species)
	// throws GamaRuntimeException {
	// if ( species == null ) { return asAgent(scope, val); }
	// return (IAgent) species.getDescription().getType().cast(scope, val,
	// species, Types.NO_TYPE, Types.NO_TYPE);
	// }

	// @operator(value = IKeyword.BOOL, can_be_const = true)
	// @doc(deprecated = "generated automatically now", value = "casting of the
	// operand to a boolean value.",
	// special_cases = {
	// "if the operand is null, returns false;", "if the operand is an agent,
	// returns true if the agent is not dead;",
	// "if the operand is an int or a float, returns true if it is not equal to
	// 0 (or 0.0);",
	// "if the operand is a file, bool is formally equivalent to exists;",
	// "if the operand is a container, bool is formally equivalent to not empty
	// (a la Lisp);",
	// "if the operand is a string, returns true is the operand is true;",
	// "Otherwise, returns false." }, examples = {
	// "bool(3.78) --: true", "bool(true) --: true", "bool({23, 4.0} --: false",
	// "bool(5::34) --: false",
	// "bool(green) --: false", "bool([1,5,9,3]) --: true", "bool(node1) --:
	// true", "bool('4') --: false",
	// "bool('4.7') --: false " })
	...
	// "if the operand is a string, the allowed color names are the constants
	// defined in the android.graphics.Color class, "
	// + "i.e.: black, blue, cyan, darkGray, lightGray, gray, green, magenta,
	// orange, pink, red, white, yellow. "
	// + "Otherwise tries to cast the string to an int and returns this color",
	// "if the operand is a list, the integer value associated to the three
	// first elements of the list are used to define the three red "
	// +
	// "(element 0 of the list), green (element 1 of the list) and blue (element
	// 2 of the list) components of the color;",
	// "if the operand is a map, the red, green, blue components take the value
	// associated to the keys \"r\", \"g\", \"b\" in the map;",
	// "if the operand is a matrix, return the color of the matrix casted as a
	// list;",
	// "if the operand is a boolean, returns black for true and white for
	// false;",
	// "if the operand is an integer value, the decimal integer is translated
	// into a hexadecimal value: OxRRGGBB. "
	// + "The red (resp. green, blue) component of the color take the value RR
	// (resp. GG, BB) translated in decimal." },
	// examples = {
	// "rgb(3.78) --: rgb([0,0,3])", "rgb(true) --: rgb([0,0,0]) //black ",
	// "rgb({23, 4.0} --: rgb([0,0,0]) //black ", "rgb(5::34) --: rgb([0,0,0])
	// //black ",
	// "rgb(green) --: rgb([0,255,0]) //green ", "rgb([1,5,9,3]) --:
	// rgb([1,5,9])",
	// "rgb(node1) --: rgb([0,0,1])", "rgb('4') --: rgb([0,0,4])", "rgb('4.7')
	// --: // Exception " })
	...
	// @doc(value = "casting of the operand to a floating point value.",
	// special_cases = {
	// "if the operand is numerical value, returns its value as a floating point
	// value;",
	// "if the operand is a string, tries to convert its content to a floating
	// point value;",
	// "if the operand is a boolean, returns 1.0 for true and 0.0 for false;",
	// "otherwise, returns 0.0" }, examples = {
	// "float(7) --: 7.0", "float(true) --: 1.0", "float({23, 4.0} --: 0.0",
	// "float(5::34) --: 0.0",
	// "float(green) --: 0.0", "float([1,5,9,3]) --: 0.0", "float(node1) --:
	// 0.0", "int('4') --: 4.0",
	// "int('4.7') --: 4.7 " }, see = { "int" })
	...
	// "if the operand is a population, returns the union of each agent
	// geometry",
	// "if the operand is a pair of two agents or geometries, returns the link
	// between the geometry of each element of the operand",
	// "if the operans is a graph, returns the corresponding multi-points
	// geometry",
	// "if the operand is a container of points, if first and the last points
	// are the same, returns the polygon built from these points",
	// "if the operand is a container, returns the union of the geometry of each
	// element", "otherwise, returns nil" },
	// examples = {
	// "geometry({23, 4.0}) --: Point", "geometry(a_graph) --: MultiPoint",
	// "geometry(node1) --: Point", "geometry([{0,0},{1,4},{4,8},{0,0}]) --:
	// Polygon " })
	...
	// = {
	// "if the operand is a float, returns its value truncated (but not
	// rounded);",
	// "if the operand is an agent, returns its unique index;",
	// "if the operand is a string, tries to convert its content to an integer
	// value;",
	...
	// "otherwise, returns 0" }, examples = {
	// "int(3.78) --: 3", "int(true) --: 1", "int({23, 4.0} --: 0", "int(5::34)
	// --: 0",
	...
	// @doc(deprecated = "generated automatically now", value = "casting of the
	// operand to a pair value.", special_cases
	// = {
	// "if the operand is null, returns null;",
	// "if the operand is a point, returns the pair
	// x-coordinate::y-coordinate;",
	// "if the operand is a particular kind of geometry, a link between
	// geometry, returns the pair formed with these two geoemtries;",
	// "if the operand is a map, returns the pair where the first element is the
	// list of all the keys of the map and the second element is the list of all
	// the values of the map;",
	// "if the operand is a list, returns a pair with the two first element of
	// the list used to built the pair",
	// "Otherwise, returns the pair operand::operand." }, examples = {
	// "pair(true) --: true::true",
	// "pair({23, 4.0} --: 23.0::4.0", "pair([1,5,9,3]) --: 1::5",
	...
	// @doc(deprecated = "generated automatically now", value = "casting of the
	// operand to a string.", special_cases = {
	...
	// "if the operand is an int or a float, returns their string representation
	// (as in Java);",
	// "if the operand is a boolean, returns 'true' or 'false';",
	// "if the operand is a species, returns its name;",
	// "if the operand is a color, returns its literal value if it has been
	// created with one (i.e. 'black', 'green', etc.) or the string
	...
	// @doc(deprecated = "generated automatically now", value = "casting of the
	// operand to a point value.",
	// special_cases = {
	// "if the operand is null, returns null;",
	// "if the operand is an agent, returns its location",
	// "if the operand is a geometry, returns its centroid",
	// "if the operand is a list with at least two elements, returns a point
	// with the two first elements of the list (casted to float)",
	// "if the operand is a map, returns the point with values associated
	// respectively with keys \"x\" and \"y\"",
	// "if the operand is a pair, returns a point with the two elements of the
	// pair (casted to float)",
	// "otherwise, returns a point {val,val} where val is the float value of the
	// operand" }, examples = {
	// "point(0) --: {0.0;0.0}", "point(true) --: {1.0;1.0}", "point(5::34) --:
	// {5.0;34.0}",
	// "point([1,5,9,3]) --: {1.0;5.0}", "point([[3,7],[2,6,9],0])
	// --:{0.0;0.0}",
	// "point(['a'::345, 'y'::13, 'c'::12]) --: {0.0;13.0}",
	// "point(node1) --: {64.06165572529225;18.401233796267537} // centroid of
	// node1 shape" })
	// @Deprecated
	...
	// @doc(deprecated = "generated automatically now", value = "casting of the
	// operand to a map.", special_cases = {
	// "if the operand is pair, returns a map with this only element;",
	// "if the operand is a agent or a shape, returns a map containing all the
	// attributes as a pair attribute_name::attribute_value;",
	// "if the operand is a list, returns a map containing either elements of
	// the list if it is a list of pairs, or pairs list[i]::list[i];",
	// "if the operand is a file, returns the content casted to map;",
	// "if the operand is a graph, returns the a map with pairs
	...
	// @operator(value = IKeyword.LIST, can_be_const = true, content_type =
	// ITypeProvider.FIRST_CONTENT_TYPE_OR_TYPE)
	// @doc(value = "transforms the operand into a list", comment =
	// "list always tries to cast the operand except if it is an int, a bool or
	// a float; "
	// +
	// "to create a list, instead, containing the operand (including another
	// list), use the + operator on an empty list (like [] + 'abc').",
	// special_cases = {
	// "if the operand is a point or a pair, returns a list containing its
	// components (two coordinates or the key and the value);",
	// "if the operand is a rgb color, returns a list containing its three
	// integer components;",
	// "if the operand is a file, returns its contents as a list;",
	// "if the operand is a matrix, returns a list containing its elements;",
	// "if the operand is a graph, returns the list of vetices or edges
	// (depending on the graph)",
	// "if the operand is a species, return a list of its agents;",
	// "if the operand is a string, returns a list of strings, each containing
	// one character;",
