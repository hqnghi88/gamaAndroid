/*********************************************************************************************
 *
 * 'QuadTreeLayerStatement.java, in plugin msi.gama.core, is part of the source code of the GAMA modeling and simulation
...
@facets (
		value = { @facet (
				...
				@facet (
						...
						type = IType.LABEL,
						optional = false,
						doc = @doc ("identifier of the layer")),
				@facet (
...
@doc (
		deprecated = "The `quadtree`layer will be removed soon from the definition of displays",
		...
		usages = { @usage (
				...
				examples = { @example (
						...
						isExecutable = false),
						@example (
								value = "   quadtree 'qt' position: { 0, 0.5 } size: quadrant_size;",
								isExecutable = false),
						@example (
								value = "}",
								isExecutable = false) }) },
